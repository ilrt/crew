 ...
 * @version $Id: MemoryCacheDatabase.java 1132 2009-03-20 19:05:47Z cmmaj $
 */
public class MemoryCacheDatabase extends AbstractDatabase {
    ...
    public MemoryCacheDatabase(String configPrefix, String dbConfigFile) throws Exception {
    ...
    public Data getData() throws DataException {
        return new MemoryCacheData(datasource);
    }
    ...
    private class MemoryCacheData implements Data {
        ...
        public MemoryCacheData(Dataset dataset) {
