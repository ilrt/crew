...
<body>
                    ...
                    <div class="yui-gc">
                        <div class="yui-u first" id="content" style="width: 98%"> <!-- width: 66%; float: left -->
                            <div id="content-header">
                                <h1 class="title"><fmt:message key="profile.link.changePassword"/></h1> <%-- Mid column main page title --%>
                                  ...
                                  <div class="tabs" style="width:100%">
                                      <ul class="tabs primary">
                                            ...
                                            <li><a href="updateUserDetails.do"><fmt:message key="profile.link.updateDetails"/></a></li>
    ...
    <div id="content-area" style="margin-top: 2em">
        ...
        <p><fmt:message key="password.changed"/></p>

        <p><fmt:message key="password.changed.home"/></p>
