...
function initializeMap(id,route) {
  ...
  var latLngOnControl = new switchOnLatLngControl(latLngOnControlDiv, map, route);
...
function toggleMap(id,route) {
    var element = document.getElementById(id);
    if (element.style.display != 'none') {
        element.style.display = 'none';
    } else {
        element.style.display = '';
        initializeMap(id,route);
    }
}

function switchOnLatLngControl(controlDiv, map, route) {
...
function setLatLngListener(route) {
    listener = google.maps.event.addListener(map, 'click', function(event) {
            showLatLng(event.latLng, route);
    });
...
function showLatLng(location, route) {
    var latElement = "kmlStartLat" + route;
    var lngElement = "kmlStartLong" + route;
