...
<div class="user-management-container">
    ...
    <c:if test="${total > 0}">
        <form:form commandName="listRoleForm" method="post">
            ...
            <p>
                <input type="submit" name="newRole" value='<fmt:message key="list.roles.create"/>'/>
                <input type="submit" name="editRole" value='<fmt:message key="list.roles.edit"/>'/>
                <input type="submit" name="deleteRole" value='<fmt:message key="list.roles.delete"/>'/>
            </p>
        </form:form>
    </c:if>
