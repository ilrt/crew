...
<div class="user-management-container">
    ...
    <c:if test="${total > 0}">
        <form:form commandName="listUserForm">
            <table class="list-table">
                ...
                <tbody class="list-body">
                    <c:forEach var="person" items="${results}" varStatus="status">
                        ...
                        <td>
                            <c:forEach var="userGroup" items="${person.groups}" varStatus="status">
            ...
            <p>
                <input type="submit" name="editUser" value='<fmt:message key="list.users.edit"/>'/>
                <input type="submit" name="deleteUser" value='<fmt:message key="list.users.delete"/>'/>
            </p>
        </form:form>
    </c:if>
