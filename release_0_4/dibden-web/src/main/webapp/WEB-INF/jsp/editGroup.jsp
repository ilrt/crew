...
<div class="user-management-container">
    ...
    <fieldset>
        ...
        <p>
            <input type="submit" name="updateGroup" value='<fmt:message key="group.update"/>'/>
        ...
        <fieldset>
            ...
            <table>
                <c:forEach var="groupRole" items="${groupForm.groupRoles}">
                    <tr>
                        <td><form:radiobutton path="groupRoleId" value="${groupRole.roleId}"/></td>
                        <td>${groupRole.roleId}</td>
                    </tr>
                </c:forEach>
            </table>
            <p>
                <input type="submit" name="removeRole" value='<fmt:message key="group.role.remove"/>'/>
                <input type="submit" value='<fmt:message key="group.cancel"/>'/>
            </p>
        </fieldset>
    </c:if>
    ...
    <c:if test="${not empty groupForm.roles}">
        <fieldset>
            ...
            <p>
                ...
                <input type="submit" name="addRole" value='<fmt:message key="group.role.add"/>'/>
                <input type="submit" value='<fmt:message key="group.cancel"/>'/>
            </p>
        </fieldset>
    </c:if>
