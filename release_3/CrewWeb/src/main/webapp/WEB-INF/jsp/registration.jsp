...
<form:form method="post">
    ...
    <fieldset>
        ...
        <script type="text/javascript"
                src="http://api.recaptcha.net/challenge?k=6Lc_kQEAAAAAADvXvCLJu3AODue6M5SbhUu1xahZ">
        </script>
        <noscript>
            <iframe src="http://api.recaptcha.net/noscript?k=6Lc_kQEAAAAAADvXvCLJu3AODue6M5SbhUu1xahZ"
