...
/**
 * <p>Provides a method to encode any string into a URL-safe form.</p>
 * <p/>
 * <p>Non-ASCII characters are first encoded as sequences of
 * two or three bytes, using the UTF-8 algorithm, before being
 * encoded as %HH escapes.</p>
 * <p/>
 * <p>Created: 17 April 1997<br />
 * Author: Bert Bos &lt;bert@w3.org&gt;<br />
 * URLUTF8Encoder: http://www.w3.org/International/URLUTF8Encoder.java</p>
 * <p/>
 * <p>Copyright © 1997 World Wide Web Consortium, (Massachusetts
...
public class URLUTF8Encoder {
    ...
    /**
     * <p>Encode a string to the "x-www-form-urlencoded" form, enhanced
     ...
     * <li>All other ASCII characters are converted into the 3-character string
