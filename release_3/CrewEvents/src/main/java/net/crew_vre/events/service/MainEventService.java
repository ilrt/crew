...
public interface MainEventService {
    ...
    List<Event> getEventsByDate(final DateTime startDate, final DateTime endDate);

    List<Event> getEventsByDate(final DateTime startDate, final DateTime endDate, final int limit,
                                final int offset);
    ...
    int getTotalEventsByDate(final DateTime startDate, final DateTime endDate);
