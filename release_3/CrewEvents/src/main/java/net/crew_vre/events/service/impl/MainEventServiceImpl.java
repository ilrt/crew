 ...
 * @version: $Id: MainEventServiceImpl.java 1132 2009-03-20 19:05:47Z cmmaj $
 */
public class MainEventServiceImpl implements MainEventService {
    ...
    public List<Event> getEventsByDate(final DateTime startDate, final DateTime endDate) {
    ...
    public int getTotalEventsByDate(final DateTime startDate, final DateTime endDate) {
