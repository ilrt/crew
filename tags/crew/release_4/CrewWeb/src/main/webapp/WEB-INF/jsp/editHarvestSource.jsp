...
<head>
    <title><fmt:message key="edit.harvestsources.title"/></title>
    <style type="text/css"
...
<div id="container">
    ...
    <div id="mainBody">
        ...
        <div class="harvester-management-container">
            ...
            <p><fmt:message key="harvester.editSource.msg"/></p>

            <fieldset>
                <legend><strong><fmt:message key="harvester.addSource.legend"/></strong></legend>

                <form:form action="./editHarvestSource.do" method="post" commandName="source">

                    <table>
                        <tr>
                            <td><strong><fmt:message key="harvester.form.location"/></strong></td>
                            <td><form:input path="location" readonly="true" size="40"/></td>
                        ...
                        <tr>
                            <td colspan="3">
                                <input type="submit" name="updateButton" value="<fmt:message key="harvester.form.ok"/>"/>
