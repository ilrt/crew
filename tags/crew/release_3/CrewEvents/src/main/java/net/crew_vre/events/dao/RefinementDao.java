...
public interface RefinementDao {
     ...
     */
    List<Refinement> findNames(String widerProperty, String subjectUri);
     ...
     * @return a list of refinements.
     */
    List<Refinement> findProperties(String linkProperty);
     ...
     */
    Refinement findParents(String linkProperty, String childUri);
     ...
     */
    List<CountItem> countRefinements(String sparqlFragment, String type);
}
