...
public class PersonDaoImpl implements PersonDao {
     ...
     */
    public PersonDaoImpl(final DatasetFactory datasetFactory, final JenaQueryUtility jqUtility,
                         final EventDao eventDao) {
        this.dataset = datasetFactory.create();
        this.jqUtility = jqUtility;
        this.eventDao = eventDao;

        this.sparqlFindPeople = jqUtility.loadSparql("/sparql/person-basic-details.rq");
        this.sparqlFindPeopleFragment =
                jqUtility.loadSparql("/sparql/person-basic-details-fragment.rq");
        this.sparqlFindPersonFull = jqUtility.loadSparql("/sparql/person-full-details.rq");
        this.sparqlFindRoles = jqUtility.loadSparql("/sparql/person-find-roles.rq");
        this.sparqlFindPeronByEventId =
                jqUtility.loadSparql("/sparql/person-full-details-by-event.rq");
        this.sparqlFindAuthors = jqUtility.loadSparql("/sparql/person-authors.rq");
    }
    ...
    private List<Person> findPeople(final String sparql, final boolean full) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparql, dataset, null);
    ...
    private List<Role> findRoles(final Person person) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparqlFindRoles, dataset, initialBindings);
        ResultSet rs = qe.execSelect();
