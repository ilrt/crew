...
public class EventDaoImpl implements EventDao {
     ...
     */
    public EventDaoImpl(final DatasetFactory datasetFactory, final JenaQueryUtility jqUtility) {
        this.dataset = datasetFactory.create();
        this.jqUtility = jqUtility;

        sparqlEvents = jqUtility.loadSparql("/sparql/event-details.rq");
        sparqlEventParts = jqUtility.loadSparql("/sparql/event-details-haspart.rq");
        sparqlEventPartOf = jqUtility.loadSparql("/sparql/event-details-partof.rq");
        sparqlEventSubjects = jqUtility.loadSparql("/sparql/event-details-subjects.rq");
        sparqlEventTags = jqUtility.loadSparql("/sparql/event-details-tags.rq");
        sparqlEventPlaces = jqUtility.loadSparql("/sparql/event-details-places.rq");
    }
    ...
    public Event findEventById(final String id) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparqlEvents, dataset, initialBindings);
    ...
    private List<Event> findEventParts(final String id) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparqlEventParts, dataset, initialBindings);
        ResultSet rs = qe.execSelect();
    ...
    private List<Event> findPartOf(List<Event> results, final String id) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparqlEventPartOf, dataset, initialBindings);
        ResultSet rs = qe.execSelect();
    ...
    private List<Subject> findEventSubjects(final String id) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparqlEventSubjects, dataset, initialBindings);
        ResultSet rs = qe.execSelect();
    ...
    private List<String> findEventTags(final String id) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparqlEventTags, dataset, initialBindings);
        ResultSet rs = qe.execSelect();
    ...
    private List<Place> findEventPlaces(final String id) {
        ...
        QueryExecution qe = jqUtility.queryExecution(sparqlEventPlaces, dataset, initialBindings);
        ResultSet rs = qe.execSelect();
