...
<div id="container">
    ...
    <div id="mainBody">
        ...
        <div id="player-container">
            ...
            <p><a href="javascript:stop();window.location.href='./displayEvent.do?eventId=' + encodeURIComponent('<crew:uri uri='${eventId}'/>');"><spring:message
            ...
            <script type="text/javascript">
                ...
                function loadVideo(divid, playerid) {
                    ...
                    mplayer.addVariable("uri", "./playRecording.do?recordingId=${recordingId}&startTime=${startTime}");
                    mplayer.write(divid);
                }
